...
/// GET /dashboard
pub async fn get_dashboard(pool: web::Data<PgPool>, hb: web::Data<Handlebars<'_>>, session:Session) -> HttpResponse {
...
pub async fn get_dashboard_with_symbol(symbol: web::Path<String>, pool: web::Data<PgPool>, hb: web::Data<Handlebars<'_>>, session:Session) -> HttpResponse {
...
/// render dashboard
async fn render_dashboard(symbol:&str, symbol_list:&Vec<String>, message:String, pool: web::Data<PgPool>, hb: web::Data<Handlebars<'_>>, session:Session) -> HttpResponse {

    let activities = Activity::get_activities_from_db_for_symbol(symbol, &pool).await.unwrap_or(vec![]);
